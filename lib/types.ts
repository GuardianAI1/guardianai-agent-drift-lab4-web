...
export interface ExperimentTurn {
  ...
  semanticCrossCheckPass?: boolean | null;
  healthAcceptanceBlocked?: boolean;
  healthAcceptanceDecision?: "ACCEPT" | "BLOCK";
...
export interface ExportMetrics {
  ...
  healthSafeModeEnabled?: boolean;
  healthAcceptanceBlockedCount?: number;
  healthAcceptanceBlockedRate?: number | null;
  semanticCrossCheckPassCount?: number;
  semanticCrossCheckPassRate?: number | null;
...
export interface ExportSnapshot {
  ...
  comparatorMode?: "rawByteExact" | "canonicalJson";
